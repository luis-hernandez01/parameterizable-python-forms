from sqlalchemy import Column, BigInteger, Integer, String, Enum, JSON, Text, TIMESTAMP, ForeignKey, Enum as SQLEnum
...
class Log(Base):
    ...
    id = Column(BigInteger, primary_key=True, autoincrement=True, comment="Identificador único del log")
    ...
    tipo_operacion = Column(SQLEnum(TipoOperacionEnum), nullable=False, comment="Tipo de operación realizada")
