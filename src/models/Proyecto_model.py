...
class Proyecto(Base):
    ...
    id_tipoclasificacion_modo = Column(Integer, ForeignKey("tipo_clasificacion_modos.id"), nullable=True)
    catalogo = Column(Integer, ForeignKey("catalogo_modoXtipo_clasificacion.id"), nullable=True)
